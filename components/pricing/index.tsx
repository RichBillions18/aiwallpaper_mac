      ...
      <div className="mx-auto w-full max-w-7xl px-5 py-16 md:px-10 md:py-24 lg:py-32">
        ...
        <ul className="m-auto grid w-full grid-flow-row grid-cols-1 gap-8 md:grid-cols-2 md:gap-4 lg:w-[70%]">
          <li className="flex max-w-md flex-col items-start justify-self-center border border-solid border-[#dfdfdf] p-8">
            ...
            <button className="mb-5 flex w-full grid-cols-2 flex-row items-center justify-center border-2 border-solid border-black px-8 py-4 text-center font-semibold text-black transition [box-shadow:rgb(0,_0,_0)_-8px_8px] hover:[box-shadow:rgb(0,_0,_0)_0px_0px] md:mb-6 lg:mb-8">
